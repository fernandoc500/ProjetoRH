    ...
    public partial class zero : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Cargo", t => t.CargoId, cascadeDelete: true)
                .ForeignKey("dbo.Empregado", t => t.EmpregadoId, cascadeDelete: false)
                ...
                c => new
                    {
                        ...
                        DataExtincao = c.DateTime(nullable: false),
                        SetorPaiId = c.Int(nullable: false),
                        ResponsavelId = c.Int(nullable: false),
                        Atividades = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Empregado", t => t.ResponsavelId, cascadeDelete: false)
